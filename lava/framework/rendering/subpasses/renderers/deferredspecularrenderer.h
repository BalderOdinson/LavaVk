...
#ifndef DEFERRED_DEFERREDSPECULARRENDERER_H
#define DEFERRED_DEFERREDSPECULARRENDERER_H
...
namespace LavaVk
{
    class DeferredSpecularRenderer : public ComponentRenderer
    {
    public:
        explicit DeferredSpecularRenderer(InjectionContext
        &context);
...
#endif //DEFERRED_DEFERREDSPECULARRENDERER_H
